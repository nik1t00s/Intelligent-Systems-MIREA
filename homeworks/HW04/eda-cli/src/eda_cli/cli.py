...
def report(
    ...
    min_missing_share: float = typer.Option(0.5, help="Порог доли пропусков для определения 'проблемных' колонок."),
    ...
    # 2. Качество в целом (с использованием новых параметров)
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Слишком много пропусков (порог {min_missing_share:.0%}): **{quality_flags['too_many_missing']}**\n")
        ...
        f.write(f"## Гистограммы числовых колонок (максимум {max_hist_columns} колонок)\n\n")
